  ...
  return (
    <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-3">
      ...
      <div>
        ...
        <input name="zipCode" defaultValue={address?.zipCode} placeholder="00000000" maxLength={8} className="w-full border border-stone-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500" onChange={(e) => { e.target.value = e.target.value.replace(/\D/g, "").slice(0, 8) }} />
      </div>
